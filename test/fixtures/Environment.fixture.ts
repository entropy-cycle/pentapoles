...
import { Environment, LocalInformation, Pole } from '../../src';
import { Vector3 } from '../../src/vector'

export default function createFixture() {
    const environment = new Environment(null, [], new LocalInformation(null, new Vector3(0, 0, 0), new Vector3(0, 0, 0)));
    ...
    for (let i = 0; i < 5; i++) {
        ...
        const pole = new Pole(ginfo, localInformation.source.children, 0x191e)
