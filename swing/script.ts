...
class Information { // only has state information (polarity, radius, etc.), has no position or velocity since it has no location
...
class LocaleInformation extends Information { // information that has a position and velocity. Describes the state of an object in the environment including its position and velocity and rotation
...
class Environment {
    ...
    addLocality(info: Environment, psosition: Vector3, radius: Vector3) {
        const localeInfo = new LocaleInformation(this, info, radius);
        localeInfo.position = psosition;
    ...
    addLocaleInformation(info: LocaleInformation, psosition: Vector3, radius: Vector3) {
...
const environment = new Environment(undefined, Information.NULL);

// create several localities and add then to the environment
const locality1 = new Locality(environment, [], new Vector3(0, 0, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 0));
const locality2 = new Locality(environment, [], new Vector3(100, 100, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 0));
const locality3 = new Locality(environment, [], new Vector3(200, 200, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 0));

environment.addLocality(locality1, Vector3.r(10), Vector3.r(3));
environment.addLocality(locality2, Vector3.r(10), Vector3.r(3));
environment.addLocality(locality3, Vector3.r(10), Vector3.r(3));

const renderer = new Renderer(canvas, environment);
renderer.render(new Vector3(-10, 0, 0), new Vector3(0, 0, 0), new Vector3(1000, 1000, 1000));
