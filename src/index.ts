...
export class Environment {
    ...
    getGlobalInformation(): LocalInformation { return this.globalInformation; }
    absorb(local: Emission): Absorption[] { return [new Absorption(this.parent, local.source, this.globalInformation.position, this.globalInformation.velocity)]; }
    listen(local: Absorption): Listening[] { return [new Listening(this.parent, local.source, this.globalInformation.position, this.globalInformation.velocity)]; }
    execute(local: Listening): Execution[] { return [new Execution(this.parent, local.source, this.globalInformation.position, this.globalInformation.velocity)]; }
    mediate(local: Execution): Mediation[] { return [new Mediation(this.parent, local.source, this.globalInformation.position, this.globalInformation.velocity)]; }
    emit(local: Mediation): Emission[] { return [new Emission(this.parent, local.source, this.globalInformation.position, this.globalInformation.velocity)];}
...
export class Absorber extends Environment {
    constructor(public parent: LocalInformation | null, public informations: LocalInformation[], public information: LocalInformation) { super(parent, informations, information); }
...
export class Emitter extends Environment {
    constructor(public parent: LocalInformation | null, public informations: LocalInformation[], public information: LocalInformation) { super(information.source, informations, information); }
...
export class Pole extends Environment {
    ...
    emit(local: LocalInformation): Emission[] { return this.radiator.emit(local.source); }
    getLocalInformation(position: Vector3, velocity: Vector3): LocalInformation {
        ...
        const emissions: any = medFlat.forEach((mediation:any) => this.radiator.emit(mediation));
