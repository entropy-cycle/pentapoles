...
export declare class Environment {
    ...
    globalInformation?: LocalInformation | undefined;
    _children: Environment[];
    children(): Environment[];
    constructor(parent: LocalInformation | null, localInformations?: LocalInformation[], globalInformation?: LocalInformation | undefined);
...
export declare class EnvironmentRenderer {
    ...
    position: Vector3;
    velocity: Vector3;
    constructor(canvas: any, environment: Environment, position: Vector3, velocity: Vector3);
