...
describe('Vector2', () => {
    describe('constructor', () => {
        it('should create a new Vector2 with the given x and y values', () => {
            const v = new vector_1.Vector2(1, 2);
            (0, chai_1.expect)(v.x).to.equal(1);
            (0, chai_1.expect)(v.y).to.equal(2);
        });
    });
    describe('add', () => {
        it('should add the given vector to the current vector', () => {
            const v = new vector_1.Vector2(1, 2);
            const v2 = new vector_1.Vector2(3, 4);
            const v3 = v.add(v2);
            (0, chai_1.expect)(v3.x).to.equal(4);
            (0, chai_1.expect)(v3.y).to.equal(6);
        });
    });
    describe('sub', () => {
        it('should subtract the given vector from the current vector', () => {
            ...
            const v2 = new vector_1.Vector2(3, 4);
            const v3 = v.sub(v2);
            (0, chai_1.expect)(v3.x).to.equal(-2);
            (0, chai_1.expect)(v3.y).to.equal(-2);
        });
    });
    describe('multiply', () => {
        it('should multiply the given vector by the current vector', () => {
            ...
            (0, chai_1.expect)(v3.x).to.equal(3);
            (0, chai_1.expect)(v3.y).to.equal(8);
        });
    });
    describe('divide', () => {
        it('should divide the given vector by the current vector', () => {
            ...
            (0, chai_1.expect)(v3.x).to.equal(1 / 3);
            (0, chai_1.expect)(v3.y).to.equal(0.5);
        });
    });
    describe('dot', () => {
        it('should return the dot product of the current vector and the given vector', () => {
            ...
            const v2 = new vector_1.Vector2(3, 4);
            const dot = v.dot(v2);
            (0, chai_1.expect)(dot).to.equal(11);
        });
    });
    describe('multiplyScalar', () => {
        it('should multiply the current vector by the given scalar', () => {
            ...
            (0, chai_1.expect)(v2.x).to.equal(3);
            (0, chai_1.expect)(v2.y).to.equal(6);
        });
    });
    describe('divideScalar', () => {
        it('should divide the current vector by the given scalar', () => {
            ...
            (0, chai_1.expect)(v2.x).to.equal(1 / 3);
            (0, chai_1.expect)(v2.y).to.equal(2 / 3);
        });
    });
    describe('length', () => {
        it('should return the length of the current vector', () => {
            const v = new vector_1.Vector2(3, 4);
            const len = v.length();
            (0, chai_1.expect)(len).to.equal(5);
        });
    });
    describe('distanceTo', () => {
        it('should return the distance between the current vector and the given vector', () => {
            ...
            (0, chai_1.expect)(distance).to.equal(2 * Math.sqrt(2));
        });
    });
    describe('directionTo', () => {
        it('should return the direction vector from the current vector to the given vector', () => {
            ...
            (0, chai_1.expect)(v3.x).to.equal(1 / Math.sqrt(2));
            (0, chai_1.expect)(v3.y).to.equal(1 / Math.sqrt(2));
        });
    });
    describe('angleTo', () => {
        it('should return the angle between the current vector and the given vector', () => {
            ...
            (0, chai_1.expect)(angle).to.equal(1 - Math.PI / 4);
        });
    });
    describe('normalize', () => {
        it('should return the normalized vector of the current vector', () => {
            ...
            (0, chai_1.expect)(v2.x).to.equal(1 / Math.sqrt(5));
            (0, chai_1.expect)(v2.y).to.equal(2 / Math.sqrt(5));
        });
    });
    describe('normal', () => {
    ...
    describe('clone', () => {
        it('should return a clone of the current vector', () => {
            const v = new vector_1.Vector2(1, 2);
            const v2 = v.clone();
            (0, chai_1.expect)(v2.x).to.equal(v.x);
            (0, chai_1.expect)(v2.y).to.equal(v.y);
        });
    });
    describe('toString', () => {
        it('should return the string representation of the current vector', () => {
            ...
            (0, chai_1.expect)(str).to.equal('(1,2)');
        });
    });
});
describe('Vector3', () => {
    describe('add', () => {
        it('should return the sum of the current vector and the given vector', () => {
            const v = new vector_1.Vector3(1, 2, 3);
            const v2 = new vector_1.Vector3(3, 4, 5);
            const v3 = v.add(v2);
            (0, chai_1.expect)(v3.x).to.equal(4);
            (0, chai_1.expect)(v3.y).to.equal(6);
            (0, chai_1.expect)(v3.z).to.equal(8);
        });
    });
    describe('sub', () => {
        it('should return the difference of the current vector and the given vector', () => {
            ...
            (0, chai_1.expect)(v3.x).to.equal(-2);
            (0, chai_1.expect)(v3.y).to.equal(-2);
            (0, chai_1.expect)(v3.z).to.equal(-2);
        });
    });
    describe('multiply', () => {
        it('should return the product of the current vector and the given vector', () => {
            ...
            (0, chai_1.expect)(v3.x).to.equal(3);
            (0, chai_1.expect)(v3.y).to.equal(8);
            (0, chai_1.expect)(v3.z).to.equal(15);
        });
    });
    describe('divide', () => {
        it('should return the quotient of the current vector and the given vector', () => {
            ...
            const v3 = v.divide(v2);
            (0, chai_1.expect)(v3.x).to.equal(1 / 3);
            (0, chai_1.expect)(v3.y).to.equal(1 / 2);
            (0, chai_1.expect)(v3.z).to.equal(3 / 5);
        });
    });
    describe('dot', () => {
        it('should return the dot product of the current vector and the given vector', () => {
            ...
            const v2 = new vector_1.Vector3(3, 4, 5);
            const dot = v.dot(v2);
            (0, chai_1.expect)(dot).to.equal(26);
        });
    });
    describe('multiplyScalar', () => {
        it('should return the product of the current vector and the given scalar', () => {
            ...
            (0, chai_1.expect)(v2.x).to.equal(2);
            (0, chai_1.expect)(v2.y).to.equal(4);
            (0, chai_1.expect)(v2.z).to.equal(6);
        });
    });
    describe('divideScalar', () => {
        it('should return the quotient of the current vector and the given scalar', () => {
            ...
            (0, chai_1.expect)(v2.x).to.equal(1 / 2);
            (0, chai_1.expect)(v2.y).to.equal(2 / 2);
            (0, chai_1.expect)(v2.z).to.equal(3 / 2);
        });
    });
    describe('length', () => {
        it('should return the length of the current vector', () => {
            ...
            (0, chai_1.expect)(length).to.equal(Math.sqrt(14));
        });
    });
    describe('distanceTo', () => {
        it('should return the distance between the current vector and the given vector', () => {
            ...
            const v2 = new vector_1.Vector3(3, 4, 5);
            const distance = v.distanceTo(v2);
            (0, chai_1.expect)(distance).to.equal(Math.sqrt(12));
        });
    });
    describe('directionTo', () => {
        it('should return the direction from the current vector to the given vector', () => {
            ...
            (0, chai_1.expect)(direction.x).to.equal(2 / Math.sqrt(12));
        });
    });
    describe('angleTo', () => {
        it('should return the angle between the current vector and the given vector', () => {
            ...
            const v2 = new vector_1.Vector3(3, 4, 5);
            const angle = v.angleTo(v2);
            (0, chai_1.expect)(angle).to.equal(Math.acos(26 / (Math.sqrt(14) * Math.sqrt(50))));
        });
    });
    describe('normalize', () => {
        it('should return the current vector normalized', () => {
            const v = new vector_1.Vector3(1, 2, 3);
            const v2 = v.normalize();
            (0, chai_1.expect)(v2.x).to.equal(1 / Math.sqrt(14));
            (0, chai_1.expect)(v2.y).to.equal(2 / Math.sqrt(14));
            (0, chai_1.expect)(v2.z).to.equal(3 / Math.sqrt(14));
        });
    });
    describe('normal', () => {
        it('should return the current vector normalized', () => {
    ...
    describe('clone', () => {
        it('should return a copy of the current vector', () => {
            const v = new vector_1.Vector3(1, 2, 3);
            const v2 = v.clone();
            (0, chai_1.expect)(v2.x).to.equal(1);
            (0, chai_1.expect)(v2.y).to.equal(2);
            (0, chai_1.expect)(v2.z).to.equal(3);
        });
    });
    describe('projectTo2d', () => {
        it('should return the 2d projection of the current vector', () => {
            const v = new vector_1.Vector3(1, 2, 3);
            const camera = new vector_1.Vector3(1, 1, 1);
            const screen = new vector_1.Vector2(1, 1);
            const rotation = new vector_1.Vector3(1, 1, 1);
            const scale = 1;
    ...
    describe('toString', () => {
        it('should return a string representation of the current vector', () => {
            const v = new vector_1.Vector3(1, 2, 3);
            const str = v.toString();
            (0, chai_1.expect)(str).to.equal('(1,2,3)');
        });
    });
});
